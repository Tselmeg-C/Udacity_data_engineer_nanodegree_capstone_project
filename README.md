...
data modelling, ETL, PySpark, Data Lake

Overview    
The purpose of the data engineering capstone project is to to combine what I've learned throughout the Nanodegree program. I have chosen to complete the project provided by Udacity with steps outlined below.

I have worked with four datasets to complete this project. The main dataset include data on immigration to the United States, and supplementary datasets include data on airport codes, U.S. city demographics, and temperature data.
